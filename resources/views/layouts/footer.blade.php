    <footer class="mt-5">
        <div class="container text-white py-4">
            <div class="row d-flex align-items-center">
                ...
                <div class="col text-start text-lg-end mb-2">
                    <a href="https://discord.gg/mestermc" target="_blank" class="social"><i class="fi fi-brands-discord"></i></a>
                    <a href="https://www.facebook.com/Mestermc.hu" target="_blank" class="social"><i class="fi fi-brands-facebook"></i></a>
                </div>
            </div>
        </div>
    </footer>
