        ...
        <div class="bg-surface-0 dark:bg-surface-950 w-full md:w-5/12 px-8 py-20 md:px-12 lg:px-16 flex flex-col gap-12 rounded min-h-screen justify-center">
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="mt-2">
                <span class="text-surface-700 dark:text-surface-200">Nincs még fiókod?</span>
                <a href="{{ url('/register') }}" class="text-primary-500 font-medium cursor-pointer hover:text-primary-600 ml-1">Regisztrálj itt!</a>
              </div>
            </div>
          </div>
          <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
              ...
              <input type="text" class="p-inputtext p-component w-full p-3 rounded-md shadow-sm" data-p="" id="username" placeholder="Steve_the_Miner" data-pc-name="inputtext" pc10="" data-pc-section="root">
              <!---->
            </div>
            <div class="flex flex-col gap-2">
              <label for="password" class="text-surface-900 dark:text-surface-0 font-medium">Jelszó</label>
              <input type="password" class="p-inputtext p-component w-full p-3 rounded-md shadow-sm" data-p="" id="password" placeholder="••••••••" data-pc-name="inputtext" pc11="" data-pc-section="root">
              <!---->
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div class="p-checkbox p-component" id="rememberme" data-pc-name="checkbox" pc12="" data-pc-section="root" data-p-checked="false" data-p-disabled="false" data-p="">
                  <input type="checkbox" class="p-checkbox-input" data-pc-section="input">
                  <div class="p-checkbox-box" data-pc-section="box" data-p="">
                    <!---->
                  </div>
                </div>
                <label for="rememberme" class="text-surface-900 dark:text-surface-0">Emlékezz rám</label>
              </div>
              <a class="text-surface-500 dark:text-surface-400 font-medium cursor-pointer hover:text-surface-600 dark:hover:text-surface-300"> Elfelejtetted a jelszót? </a>
            </div>
          </div>
          <div>
            <button class="p-button p-component w-full !px-12 !py-3" data-p="" type="button" disabled="disabled" aria-label="Bejelentkezés a bányaközpontba" data-pc-name="button" data-p-disabled="true" pc13="" data-pc-section="root">
              <!---->
              <span class="p-button-label" data-pc-section="label" data-p="">Bejelentkezés a bányaközpontba</span>
              <!---->
            </button>
          </div>
          <div class="flex flex-col gap-4">
            <div class="flex items-center gap-4">
              <hr class="flex-1 border-surface-200 dark:border-surface-800">
              <span class="text-surface-500 dark:text-surface-400 text-sm">vagy</span>
              <hr class="flex-1 border-surface-200 dark:border-surface-800">
            </div>
            <button class="p-button p-component p-button-secondary p-button-outlined w-full !px-12 !py-3" data-p="outlined" type="button" disabled="disabled" aria-label="Discord bejelentkezés" data-pc-name="button" data-p-disabled="true" data-p-severity="secondary" pc14="" data-pc-section="root">
              <span class="p-button-icon p-button-icon-left pi pi-discord" data-p="left" data-pc-section="icon"></span>
              <span class="p-button-label" data-pc-section="label" data-p="">Discord bejelentkezés</span>
              <!---->
            </button>
            <small class="text-center text-surface-500 dark:text-surface-400 text-xs"> Discord bejelentkezés hamarosan elérhető </small>
          </div>
        </div>
